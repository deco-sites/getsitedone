...
export default function Section({ services, title, backgroundColor, id }: Props) {
  return (
    <div style={{ backgroundColor }} id={id} className="flex flex-col items-center py-20 bg-[#fafafa]">
      {title && <h2 className="text-5xl font-extrabold mb-16 text-center text-gray-800" dangerouslySetInnerHTML={{ __html: title }} />}
